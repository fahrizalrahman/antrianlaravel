  ...
  <div class="row" style="margin-top:20px;">
    ...
    <div class="col-md-4" style="width:auto; height:auto;">
      <table style="margin-left:-15px; margin-right:-14px;">
        <tr>
          <td class="col-md-4" style="background-color:darkcyan;">PENGADUAN KONSUMEN</td>
        ...
        <tr>
          <td class="col-md-4" style="background-color:darkcyan;">EVALUASI SITE MASTER PLAN</td>
          <td rowspan="2" style="background-color:brown;"><h1>001</h1></td>
        </tr>
        <tr>
          <td class="col-md-4" style="background-color:dodgerblue; border-color:red;">Loket 1</td>
        ...
        <tr>
          <td class="col-md-4" style="background-color:darkcyan;">PERIJINAN EKSPORT</td>
          <td rowspan="2" style="background-color:brown;"><h1>001</h1></td>
        </tr>
        <tr>
          <td class="col-md-4" style="background-color:dodgerblue; border-color:red;">Loket 1</td>
        ...
        <tr>
          <td class="col-md-4" style="background-color:darkcyan;">KONSULTASI PANGAN</td>
          <td rowspan="2" style="background-color:brown;"><h1>001</h1></td>
        </tr>
        <tr>
          <td class="col-md-4" style="background-color:dodgerblue; border-color:red;">Loket 1</td>
        ...
        <tr>
          <td class="col-md-4" style="background-color:darkcyan;">KONSULTASI DISTRIBUSI ONPP</td>
          <td rowspan="2" style="background-color:brown;"><h1>001</h1></td>
        </tr>
        <tr>
          <td class="col-md-4" style="background-color:dodgerblue; border-color:red;">Loket 1</td>
...
{{-- 
    <div class="col-md-12" style="background-color:steelblue; width:auto; height:30px;">
        <p><marquee>KANTOR BADAN PENGAWAS OBAT DAN MAKANAN</marquee></p>
      </div> --}}
